...
func TestMemcacheCache(t *testing.T) {
	...
	if v, err := strconv.Atoi(string(bm.Get("vseledkin").([]byte))); err != nil || v != 1 {
		t.Error("get err")
	}
	...
	if v, err := strconv.Atoi(string(bm.Get("vseledkin").([]byte))); err != nil || v != 2 {
		t.Error("get err")
	}
	...
	if v := bm.Get("vseledkin").([]byte); string(v) != "author" {
		t.Error("get err")
	}
